fun main(){
    ...
    if(nama == "IRPAN"){
        ...
        println("Anda bukan aku")
    }

    // NYOBA ELSE IF
    val nilai1 = 10
    if(nilai1 <= 5){
        println("nilai anda kurang dari 5 ") // jika nilai anda kurang dari 11
    }
    else if (nilai1 >=10){
        ...
        println("nilai anda sih apa") // jika nilai anda tidak kurang dari 11,lebih dari 15,nilai tidak sama dengan nilai1
    }
